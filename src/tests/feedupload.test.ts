...
describe('FeedUpload Integration', () => {
	...
	it('should validate a complete photo post as created by FeedUpload', () => {
		...
		const postData = {
			...
			likes: [],
			comments: [],
			imageUrl: 'https://storage.googleapis.com/test-bucket/posts/test-user-123/1234567890-image.jpg',
			imagePath: 'https://storage.googleapis.com/test-bucket/posts/test-user-123/1234567890-image.jpg',
			imagePaths: ['https://storage.googleapis.com/test-bucket/posts/test-user-123/1234567890-image.jpg']
		};
	...
	it('should validate a complete video post as created by FeedUpload', () => {
		...
		const postData = {
			...
			likes: [],
			comments: [],
			videoPath: 'https://storage.googleapis.com/test-bucket/posts/test-user-123/1234567890-video.mp4'
		};
