...
<div class="rounded-2xl bg-white shadow-sm p-6 text-center">
	<h3 class="mb-2 text-lg font-semibold text-green-600 flex items-center justify-center">
		📖 Daily Ayah
	</h3>
	<p class="mb-3 text-xl font-arabic leading-relaxed text-gray-900">
		{todayAyah.arabic}
	</p>
	<p class="italic text-gray-700">"{todayAyah.translation}"</p>
