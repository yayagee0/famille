export const prophetQuestions = [
	...
	},
	{
		...
		format: 'mcq',
		options: [
			'His grandfather Abdul Muttalib, then his uncle Abu Talib',
			'Only his father',
			'His teacher'
		],
		feedback_en:
			'He was first raised by his grandfather Abdul Muttalib, then by his uncle Abu Talib.',
	...
	},
	{
		...
		feedback_en:
			'Yes, he had sons and daughters. The most known are Fatimah, Ruqayyah, Umm Kulthum, Zaynab, Qasim, Abdullah, and Ibrahim.',
		feedback_ar:
			'نعم، كان له أولاد وبنات، منهم فاطمة، رقية، أم كلثوم، زينب، القاسم، عبد الله، وإبراهيم',
		reference: 'Seerah'
	},
	{
		id: 'prophet-21',
	...
	},
	{
		...
		feedback_en:
			'He worked as a shepherd in his youth and later as a trustworthy merchant (Al-Amin).',
