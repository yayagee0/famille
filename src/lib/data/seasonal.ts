...
export const seasonalNudgeTemplates = [
	{
		...
		template: '{{character}} This Ramadan, let your {{trait}} nature help you grow closer to Allah! Think about {{ayah}} 🌙',
	...
	},
	{
		...
		template: '{{character}} Eid Mubarak! Your {{trait}} spirit makes this celebration even more special! 🎉',
	...
	},
	{
		...
		template: '{{character}} Summer is perfect for your {{trait}} adventures! What will you explore today? ☀️',
	...
	},
	{
		...
		template: '{{character}} Cozy winter days are perfect for reflecting on {{ayah}} with your {{trait}} heart ❄️',
		character: 'noor' as const,
		season: 'winter',
		weight: 15
	}
